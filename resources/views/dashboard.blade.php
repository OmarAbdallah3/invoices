...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="main-dashboard-header-right">
            ...
            <div>
                <label class="tx-13">المبيعات الاونلاين</label>
                <h5>563,275</h5>
            </div>
            <div>
                <label class="tx-13">المبيعات الاوفلاين</label>
                <h5>783,675</h5>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
      ...
      var nspainvoices2 =  {{ Js::from($nspainvoices2) }};
      var nspainvoices1 =  {{ Js::from($nspainvoices1) }};
	  var nspainvoices3 =  {{ Js::from($nspainvoices3) }};
