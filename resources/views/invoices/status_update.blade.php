                    ...
                    <form action="{{ route('status_update', ['id' => $invoices->id]) }}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="invoice_cate" placeholder="YYYY-MM-DD"
                                    type="text" value="{{ $invoices->invoice_cate }}" required readonly>
                            </div>

                            <div class="col">
                                <label>تاريخ الاستحقاق</label>
                                <input class="form-control fc-datepicker" name="cue_date" placeholder="YYYY-MM-DD"
                                    type="text" value="{{ $invoices->cue_date }}" required readonly>
                            </div>
