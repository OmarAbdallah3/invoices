            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="col-sm-6 col-md-3 mg-t-10 mg-md-t-0">
                        <a class="btn btn-success-gradient btn-block" data-effect="effect-fall" data-toggle="modal"
                            href="#select2modal">+ اضافة منتج</a>
                        <div class="modal fade" id="select2modal" tabindex="-1" role="dialog"
                            aria-labelledby="exampleModalLabel"aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="select2modal">اضافة منتج</h5>
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length="50">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">التعديلات</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                                    ...
                                                    <form action="products/destroy" method="post">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <input class="form-control" name="product_name"
                                                                id="product_name" type="text" readonly>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary"
